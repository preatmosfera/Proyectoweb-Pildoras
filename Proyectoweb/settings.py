...
SECRET_KEY = 'django-insecure-kpx_7i^73iqe_#29_4(yl7@5*)9p3q0!3+o)*gd+al+r$4+v@)'
...
EMAIL_BACKEND = "django.core.mail.backends.smtp.EmailBackend"  # Nota: Es "smtp", no "smte".
...
EMAIL_HOST_PASSWORD = "xxxxxxxxxxxxxxxxx"  # La contraseña del correo (puede ser un token de aplicación).
